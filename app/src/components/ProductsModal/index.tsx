...
import { Image,CloseButton,Header, ModalBody,IngredientsContainer,Ingredient,Footer, FooterContainer,PriceContainer } from './style';
...
export function ProductModal({visible,onClose,product,onAddToCart}:ProductsModalProps){
  if(!product){
    return null;
  }
